...
def handle_user_connection(connection: socket.socket, address: str) -> None:
    ...
    while True:
        ...
        try:
            ...
            print(f'Virhe käsitellessä käyttöliittymän yhteyttä palvelimeen. Yhteys katkaistu käyttäjän tai palvelimen toimesta: {e}')
    ...
    for client_conn in connections:
        ...
        if client_conn != connection:
            ...
            # if it fails, there is a chance of socket has died
                ...
                print('Virhe viestin välityksen yhteydessä: {e}')
...
def server() -> None:
    ...
    try:
        ...
        print('Palvelin käynnistyyi onnistuneesti!')
        ...
        print(f'Virhe käyttöliittymän tarvitsemaa ohjainta käsitellessä: {e}')
